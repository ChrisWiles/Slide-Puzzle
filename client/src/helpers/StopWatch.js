function Stopwatch() {
  ...
  // Duration
  this.time = () => formatTime(lapTime + (startAt ? now() - startAt : 0))
}
...
function formatTime(time) {
  ...
  h = Math.floor(time / (60 * 60 * 1000)) // eslint-disable-next-line
  time = time % (60 * 60 * 1000)
  m = Math.floor(time / (60 * 1000)) // eslint-disable-next-line
  time = time % (60 * 1000)
